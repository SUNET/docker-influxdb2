...
FLAGS="--http-bind-address=0.0.0.0:9999 --log-level debug --reporting-disabled --tls-cert=/etc/dehydrated/certs/influx-1.sunet.se.crt --tls-key=/etc/dehydrated/certs/influx-1.sunet.se.key"
